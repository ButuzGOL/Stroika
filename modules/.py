...
__author__    = 'r0n9.GOL (ron9.gol@gmail.com)'
...
class Base:
    ...
    def __init__(self, MySql, window):
        ...
        self.box2 = gtk.HBox()
        self.box2.pack_start(list_frame)
                                
        self.box1.add(self.box2)        
    ...
    def editForm(self):
        ...
        temp = [i for i in self.liststore if i[1] == True]        
    ...
    def viewFormEl(self, wd, index):
        ...
        for i in range(l):
            ...
            table.attach(view_sername, 1, 2, 0, 1, 
                         yoptions = gtk.FILL)
            ...
            table.attach(view_company, 1, 2, 2, 3, 
                         yoptions = gtk.FILL)
            ...
            table.attach(view_email, 1, 2, 3, 4, 
                         yoptions = gtk.FILL)
